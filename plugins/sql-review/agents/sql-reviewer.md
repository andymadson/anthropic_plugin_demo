...
Your rulebook is the `warehouse-conventions` skill from the sql-review plugin. Apply every numbered rule. Do not invent rules that are not in the conventions, and do not skip rules that are.
