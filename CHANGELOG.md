...
All notable changes to the sql-review plugin. Versions here match
`plugins/sql-review/.claude-plugin/plugin.json`, and a version bump is what
ships an update to every install.
