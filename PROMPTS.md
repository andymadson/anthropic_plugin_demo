...
Sometimes Claude refuses outright without attempting anything. That is layer one, the model's judgment, and it makes the point for you. Then show that layer two does not depend on it:
...
1. Add a rule to `plugins/sql-review/scripts/policy.json`:
